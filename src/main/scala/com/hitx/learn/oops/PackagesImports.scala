package com.hitx.learn.oops

import com.hitx.learn.practice.{Cons, LList}
...
object PackagesImports { // top-level definition
  ...
  val aList: LList[Int] = ??? // throws NotImplementedError

  // import

  import com.hitx.learn.practice.LList
  ...
  // import everything
  import com.hitx.learn.practice.*
  ...
  import com.hitx.learn.oops.* // import the mol and computeMyLife
